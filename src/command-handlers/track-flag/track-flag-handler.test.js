...
import { TrackFlagHandler } from './track-flag-handler.ts';
import { expect } from '@std/expect';

const trackFlagHandler = new TrackFlagHandler();

describe('TrackFlagHandler', () => {
  it('should return the correct command name', () => {
    expect(trackFlagHandler.name).toBe('pop-trackflag');
  });

  it('should return the correct description', () => {
    expect(trackFlagHandler.description).toBe('Mark a flag as completed.');
  });

  // it('should return flags by tier', () => {
  //   const tierFlags = trackFlagHandler.trackFlag();
